...
function Hero() {
  return (
    ...
    >
      ...
      {/* Translucent Box */}
      <div
        className="relative flex flex-col items-center gap-9 p-16 rounded-xl shadow-lg mx-auto mt-20"
        style={{
      ...
      >
        ...
        <h1 className="font-bold text-[40px] md:text-[60px] text-center">
          <span className="text-[#f56551]">Personalised Itineraries at Your Fingertips</span>
        </h1>
        ...
        {/* Button */}
        <Link to={'/create-trip'}>
          <Button className="bg-[#f56551] text-white hover:bg-[#e53e3e] transition duration-300 ease-in-out px-6 py-3 rounded-md shadow-lg text-lg font-medium">
            Get Started Now
          </Button>
        </Link>
      </div>
